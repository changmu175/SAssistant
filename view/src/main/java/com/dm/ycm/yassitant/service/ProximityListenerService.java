...
public class ProximityListenerService extends Service implements View.OnTouchListener {
    ...
    public void onCreate() {
        ...
        preferenceHelper = new SharePreferenceHelper(this, ConstDef.PROXIMITY_SERVICE);
        preferenceHelper.saveIntegerData(ConstDef.SERVICE_IS_WORKING, 1);
    ...
    public void onDestroy() {
        ...
        if (preferenceHelper != null) {
            preferenceHelper.saveIntegerData(ConstDef.SERVICE_IS_WORKING, 0);
        }
        SharePreferenceHelper servicePreferenceHelper = new SharePreferenceHelper(this, ConstDef.PROXIMITY_SERVICE);
        int isWorking = servicePreferenceHelper.getIntegerData(ConstDef.SERVICE_IS_WORKING);
    ...
    public void setFLAG_NO_CLEAR_Notification() {
        ...
        Notification notification = new Notification.Builder(this)
                ...
                .setContentTitle(getString(R.string.guard_service_is_running))
                .setContentText(getString(R.string.click_to_close_service))
                .setTicker("")
                .setWhen(when)
                .setAutoCancel(true)
