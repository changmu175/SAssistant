package com.dm.ycm.yassitant.service.aidl;
...
//        mBinder.isRunningNPCPackage();
    ...
    private void reStartNPCS() {
        ...
        in.setAction("com.dm.service.aidl");
        ...
        if (intents.size() == 1) {
            ...
            for (int i = 0; i < userId.size(); i++) {
                ...
                intent2.setPackage((intents.get(num)).getComponent().getPackageName());
    ...
    private class MyBinder extends IMyService.Stub {
        ...
        @Override
        public boolean isNeedRestart(boolean isNeed) throws RemoteException {
            isNeedRestart = isNeed;
            Log.d("isNeedRestart2", isNeedRestart + "");
            return isNeed;
        }
    }
}
