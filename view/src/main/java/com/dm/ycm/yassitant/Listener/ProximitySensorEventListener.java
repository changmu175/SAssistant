...
//        this.componentName = new ComponentName(context, LockReceiver.class);
        this.phoneGuardSPHelper = new SharePreferenceHelper(context, ConstDef.PHONE_GUARD);
    }
    ...
    private void dealSensorEvent(float value) {
        ...
        Log.d("ProximityService", secondValue + "");
        if (tempValue == 2) {
            Log.d("Proximity---firstValue", firstValue + "");
            Log.d("Proximity---secondValue", secondValue + "");
            firstValue = 100;
            secondValue = 0;
            tempValue = 0;
            //判断是否亮屏
